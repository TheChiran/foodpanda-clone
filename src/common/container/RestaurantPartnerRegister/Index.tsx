...
export default function RestaurantPartnerRegister({headerName, title, imgUrl, contentTitle, contentDescription, contentUrl}: IProps) {
    ...
    return (
        <div className="restaurant-partner-registration">
            ...
            <div className="banner-wrapper" style={{ background: `url("${imgUrl}")` }}></div>
